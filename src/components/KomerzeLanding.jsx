        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3 px-2">
            ...
            <div className="flex items-center space-x-4">
              <button className="bg-gradient-to-r from-indigo-600 to-blue-600 hidden md:inline-flex px-6 py-3 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
                Iniciar Sesión
              </button>
              <MobileMenu
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center">
            ...
            <p className="text-base md:text-lg text-slate-700 mb-8 max-w-3xl mx-auto animate-slide-up font-base">
              Convierte la experiencia de compra con tu proveedores en un
              marketplace personalizado para tu empresa
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Construido con las mejores tecnologías modernas para garantizar
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {[
              { name: "React 18.3.1", color: "text-blue-600" },
              { name: "TypeScript 5.6.2", color: "text-blue-700" },
              { name: "Vite 6.2.3", color: "text-purple-600" },
              { name: "Tailwind CSS 3.4.16", color: "text-cyan-600" },
              { name: "Supabase 2.48.0", color: "text-green-600" },
