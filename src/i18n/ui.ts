...
export const ui = {
  es: {
    ...
    hero: {
      headline: "Libertad para comprar. Control para pagar.",
      subheadline: "Crea tu propio marketplace corporativo: centraliza proveedores, desbloquea las compras y elimina la burocracia",
      cta: "Empieza la Libertad Controlada",
      notification: "✅ Solicitud auto-aprobada (Presupuesto OK)",
    },
    ticker: {
  ...
  pt: {
    ...
    hero: {
      headline: "Liberdade para comprar. Controle para pagar.",
      subheadline: "Crie seu próprio marketplace corporativo: centralize fornecedores, desbloqueie as compras e elimine a burocracia.",
      cta: "Comece a Liberdade Controlada",
      notification: "✅ Solicitação auto-aprovada (Orçamento OK)",
    },
    ticker: {
  ...
  en: {
    ...
    hero: {
      headline: "Freedom to buy. Control to pay.",
      subheadline: "Create your own corporate marketplace: centralize suppliers, unblock purchasing, and eliminate bureaucracy.",
      cta: "Start Controlled Freedom",
      notification: "✅ Auto-approved request (Budget OK)",
    },
    ticker: {
